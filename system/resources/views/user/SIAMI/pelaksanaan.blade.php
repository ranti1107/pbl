        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl bg-primary page-header">
                <div class="container text-center">
                    <h1 class="text-white animated zoomIn mb-3">Pelaksanaan AMI POLITAP</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="#">SIAMI</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Pelaksanaan AMI POLITAP</li>
                        </ol>
                        <ol style="margin-top: 20px">
                            <form action="{{url('SIAMI/Pelaksanaan-SIAMI')}}" method="post">
                                @csrf
                    ...
                    <div class="col-lg-7">
                        <div class="row g-5">
                            <div class="col-sm-12 wow fadeIn" data-wow-delay="0.1s">
                                <h3 class="mb-0">Pelaksanaan AMI POLITAP</h3>
                                ...
                                <span>Dokumen Pelaksanaan AMI POLITAP</span>
                                <ul class="list-group list-group-flush">
                                @foreach($siamis as $siami)
                                  <li class="list-group-item">{{$siami->nama}} <a class="btn btn-primary" style="float: right;" href="{{url("/public/$siami->file")}}" download> <i class="fa fa-download"></i></a> 
                                    <a data-bs-toggle="modal" data-bs-target="#modalSIAMI{{$siami->id}}" class="btn btn-success" style="float: right; margin-right: 10px"><i class="fa fa-eye"></i></a>
                                </li>
                                @endforeach
                                </ul>
                            </div>
                        ...
                        <!-- Modal -->
                            @foreach($siamis as $siami)
                            <div class="modal fade" id="modalSIAMI{{$siami->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
